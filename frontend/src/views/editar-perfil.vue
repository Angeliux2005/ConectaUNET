<template>
  <div class="min-h-screen bg-[#F8F9FB] flex flex-col font-sans w-full overflow-hidden relative">
    ...
    <main class="flex-grow w-full max-w-[1100px] mx-auto md:px-8 lg:px-12 pb-24 md:pb-16 md:pt-10 relative flex justify-center">
      ...
      <section class="md:hidden w-full bg-[#F8F9FB] min-h-screen flex flex-col relative">
        ...
        <div class="bg-white px-4 py-3.5 flex items-center justify-between sticky top-0 z-20 shadow-sm border-b border-gray-100">
          ...
          <button @click.prevent="saveProfile" class="bg-[#1e3a8a] text-white text-[13px] font-bold px-5 py-2 rounded-xl shadow-sm hover:bg-[#152a6b] transition-colors">
            Save
          </button>
        </div>
        ...
        <div class="bg-[#1e3aa8] pt-10 pb-16 flex flex-col items-center justify-center shrink-0 relative">
          <div class="relative">
            ...
            <button class="absolute bottom-0 right-0 bg-white text-[#1e3a8a] p-2 rounded-full shadow-md hover:bg-gray-50 transition-colors">
        ...
        <div class="bg-white rounded-t-[28px] -mt-8 z-10 px-6 pt-8 pb-32 flex-grow flex flex-col shadow-[0_-8px_20px_rgba(0,0,0,0.05)] border-t border-gray-100">
          <div class="space-y-5 flex-grow">
            ...
            <div class="pt-6 border-t border-gray-100 mt-6">
              ...
              <button class="w-full flex items-center justify-between rounded-2xl border border-gray-200 bg-white px-5 py-4 hover:bg-gray-50 transition-colors shadow-sm mb-3">
        ...
        <div class="bg-white rounded-[32px] border border-gray-100 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] overflow-hidden flex">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-[280px_1fr] w-full">
            ...
            <div class="bg-[#F8F9FB] border-r border-gray-100 p-8 flex flex-col items-center">
              ...
              <button class="w-full bg-white border border-gray-200 text-[#1e3a8a] text-[13px] font-bold px-4 py-2.5 rounded-xl flex items-center justify-center gap-2 shadow-sm hover:bg-gray-50 transition-colors mb-8">
              ...
              <button class="w-full flex items-center justify-center gap-2 text-gray-600 hover:text-[#1e3a8a] font-bold text-[13px] py-2 transition-colors mb-3">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                Cambiar Contraseña
              </button>
    ...
    <BottomNav class="md:hidden hidden" />
...
onMounted(() => {
  ...
  if (storedUser) {
    try {
      ...
      console.error("Error leyendo datos del usuario local", e)
    }
  } else {
...
async function saveProfile() {
  ...
  try {
    // Aquí asumo la ruta de tu backend para actualizar perfil. Ajusta si es diferente.
