...
const routes = [
  ...
  { name: 'DetallesEmprendimientoDueo', path: '/detalles-emprendimiento-dueo/:id', component: DetallesEmprendimientoDueo },
  ...
  { name: 'EditarEmprendimiento', path: '/editar-emprendimiento/:id', component: EditarEmprendimiento },
